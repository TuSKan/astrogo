...
func main() {
	...
	fmt.Println("  This carries the observer's own clock as well as their motion: the")
	fmt.Println("  second-order Doppler shift, the Sun's gravitational potential at the")
