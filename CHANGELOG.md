...
- `examples/22_kepler_propagator` — propagates 1 Ceres from real JPL-Horizons-fetched osculating elements with no SPK kernel and no network access, then runs the result through `plan.VisibilityEvents` exactly like any other target.
