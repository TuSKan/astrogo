// Package sbdb provides a resolve.Provider implementation for the NASA/JPL Small-Body Database (SBDB).
//
...
// resulting CSV structures into resolve.Target instances, preserving standard designations,
