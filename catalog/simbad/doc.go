// Package simbad provides a catalog.Provider implementation for the CDS SIMBAD Astronomical Database.
//
...
// All requests are routed through a resilient, retry-aware catalog.Client with native
