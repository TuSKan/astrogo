// Package simbad provides a resolve.Provider implementation for the CDS SIMBAD Astronomical Database.
//
...
// All requests are routed through a resilient, retry-aware resolve.Client with native
