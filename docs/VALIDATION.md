...
| Lunar Eclipse (historical) | ⚠️ misses 1, over-reports 76 | `plan/nasa_eclipse_test.go` | [NASA 5MC Lunar](https://eclipse.gsfc.nasa.gov/LEcat5/LEcatalog.html) | ≤ 1.3 min | **1451/1452** catalog eclipses detected across 6 centuries (1–2000 CE), every catalog row, mean Δ=0.8 min. The miss is the 1958-04-04 penumbral (magnitude 0.0135): astrogo decides an eclipse by a fixed 1.58° latitude limit, which excludes it while admitting shallower ones; a missed penumbral is logged, not failed. The same limit reports **76 eclipses the catalog does not have**, which this comparison, looking only from the catalog's side, never checked (#401). Until #398 the parser dropped the 28 rows whose type codes it did not list, and this row read 1424/1424 |
| Solar Eclipse (historical) | ⚠️ over-reports 97 | `plan/nasa_eclipse_test.go` | [NASA 5MC Solar](https://eclipse.gsfc.nasa.gov/SEcat5/SEcatalog.html) | ≤ 1.4 min | **1433/1433** catalog eclipses detected across 6 centuries (1–2000 CE), every catalog row, mean Δ=0.8 min. Until #398 the parser dropped the 50 rows whose type codes it did not list (hybrids, non-central eclipses, the first and last of a saros) and this row read 1383/1383; all 50 are found. The fixed 1.58° latitude limit also reports **97 eclipses the catalog does not have** (#401) |
