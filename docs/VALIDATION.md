...
| Ephemerides (SOFA analytical) | ✅ validated | `ephemeris.sofa.sun`, `ephemeris.sofa.moon` | `gofa` (Epv00 / Moon98) | 1e-7 AU | consistency check: astrogo reaches these routines through gofa |
