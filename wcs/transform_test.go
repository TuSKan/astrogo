...
func TestPixelToWorld_LinearFallback(t *testing.T) {
	...
	w := New(3)
	w.CRVAL = []float64{0.0, 0.0, 1420.0} // e.g. 1.4 GHz baseline
	w.CRPIX = []float64{10.0, 10.0, 1.0}
	w.CDELT = []float64{1.0, 1.0, 0.5}
