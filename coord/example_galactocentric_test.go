...
// from us and its distance from the center of the Galaxy are different
...
func ExampleGalactocentricFrame_FromICRS() {
	...
	// A kiloparsec of travel buys a full kiloparsec of R toward the center and
	...
	// it implies: toward the center Z drops to 18.3, and toward the pole R
	...
	// Output:
	// toward the center   R =  7178.0 pc   Z =   +18.3 pc
...
func ExampleParallaxDistance() {
	...
	fmt.Printf("distance from the center: %.1f pc\n", g.Distance().Pc())
	...
	// distance from the center: 8430.9 pc
