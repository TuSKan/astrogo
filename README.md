...
![astrogo — astronomy, computed. A night sky over an observatory ridge, with a target's altitude arc from rise through transit to set, the Moon's phase track, Jupiter and Saturn, a satellite pass, and a sky-brightness scale in mag/arcsec².](assets/hero.png)
